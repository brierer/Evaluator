...
prop_number_int i            = parseCase (NumT o (fromIntegral i))  numT   [o] where o = show (i :: Integer)
prop_number_flt f            = parseCase (NumT o f)                 numT   [o] where o = show (f :: Double)
prop_number_exp f            = parseCase (NumT o f)                 numT   [o] where o = showEFloat Nothing f ""
