...
test_MultiEmpty = do assertEqual (Left $ IllegalEmpty (1,7))  $ run     "multi([])"
                     assertEqual (Left $ IllegalEmpty (1,7))  $ runWith "multi(f())" [("f",mkArrO (1,7) [])]

test_MeanEmpty  = do assertEqual (Left $ IllegalEmpty (1,6))  $ run     "mean([])"
                     assertEqual (Left $ IllegalEmpty (1,6))  $ runWith "mean(f())" [("f",mkArrO (1,6) [])]

test_DescEmpty  = do assertEqual (Left $ IllegalEmpty (1,13)) $ run     "descriptive([])"
                     assertEqual (Left $ IllegalEmpty (1,13)) $ runWith "descriptive(f())" [("f",mkArrO (1,13) [])]
...
test_TableEmpty = do assertEqual (Left $ IllegalEmpty (1,7))  $ run     "table([],{})"
                     ...
                     assertEqual (Left $ IllegalEmpty (1,7))  $ runWith "table(f(),{})"       [("f",mkArrO (1,7)  [])]
                     assertEqual (Left $ IllegalEmpty (1,8))  $ runWith "table([f()],{})"     [("f",mkArrO (1,8)  [])]
                     assertEqual (Left $ IllegalEmpty (1,13)) $ runWith "table([[0],f()],{})" [("f",mkArrO (1,13) [])]
...
test_SortEmpty = do  assertEqual (Left $ IllegalEmpty (1,8))  $ run     "sort(0,[])"
                     ...
                     assertEqual (Left $ IllegalEmpty (1,8))  $ runWith "sort(0,f())"       [("f",mkArrO (1,8)  [])]
                     assertEqual (Left $ IllegalEmpty (1,9))  $ runWith "sort(0,[f()])"     [("f",mkArrO (1,9)  [])]
                     assertEqual (Left $ IllegalEmpty (1,14)) $ runWith "sort(0,[[0],f()])" [("f",mkArrO (1,14) [])]
...
test_ColEmpty = do   assertEqual (Left $ IllegalEmpty (1,7))  $ run     "col(0,[])"
                     ...
                     assertEqual (Left $ IllegalEmpty (1,7))  $ runWith "col(0,f())"       [("f",mkArrO (1,7)  [])]
                     assertEqual (Left $ IllegalEmpty (1,8))  $ runWith "col(0,[f()])"     [("f",mkArrO (1,8)  [])]
                     assertEqual (Left $ IllegalEmpty (1,13)) $ runWith "col(0,[[0],f()])" [("f",mkArrO (1,13) [])]
...
test_TableColumnLength = do
                     ...
                     assertEqual (Left $ TableColumnLengthMismatch (1,12) 1 2) $ runWith "table([[0],f()],{})"   [("f",mkArrO (1,12) [numO 0,numO 0])]
                     assertEqual (Left $ TableColumnLengthMismatch (1,14) 2 1) $ runWith "table([[0,0],f()],{})" [("f",mkArrO (1,14) [numO 0])]

                     assertEqual (Left $ TableColumnLengthMismatch (1,12) 1 2) $ runWith "table([f(),[0,0]],{})" [("f",mkArrO (1,8) [numO 0])]
                     assertEqual (Left $ TableColumnLengthMismatch (1,12) 2 1) $ runWith "table([f(),[0]],{})"   [("f",mkArrO (1,8) [numO 0,mkNumO (1,11) 0])]

                     assertEqual (Left $ TableColumnLengthMismatch (1,12) 1 2) $ runWith "table([f(),g()],{})"   [("f",arrO [numO 0]),       ("g",mkArrO (1,12) [numO 0,numO 0])]
                     assertEqual (Left $ TableColumnLengthMismatch (1,12) 2 1) $ runWith "table([f(),g()],{})"   [("f",arrO [numO 0,numO 0]),("g",mkArrO (1,12) [numO 0])]
...
test_TableHeaderLength = do
                     ...
                     assertEqual (Left $ TableHeaderLengthMismatch (1,13) 1 2) $ runWith "table([[0]],f())"               [("f",objO [("col",mkArrO (1,13) [strO "1",strO "2"])])]
                     assertEqual (Left $ TableHeaderLengthMismatch (1,21) 2 1) $ runWith "table([[0,0],[0,0]],f())"       [("f",objO [("col",mkArrO (1,21) [strO "1"])])]
                     ...
                     assertEqual (Left $ TableHeaderLengthMismatch (1,11) 1 2) $ runWith "table(f(),g())"                 [("f",arrO [arrO [numO 0]]),              ("g",objO [("col",mkArrO (1,11) [strO "1",strO "2"])])]
                     assertEqual (Left $ TableHeaderLengthMismatch (1,11) 2 1) $ runWith "table(f(),g())"                 [("f",arrO [arrO [numO 0],arrO [numO 0]]),("g",objO [("col",mkArrO (1,11) [strO "1"])])]
                     ...
                     assertEqual (Left $ TableHeaderLengthMismatch (1,18) 1 2) $ runWith "table([[0]],f())"                      [("f",objO [("not",mkArrO (0,0) []),("col",mkArrO (1,18) [strO "1",strO "2"])])]
                     assertEqual (Left $ TableHeaderLengthMismatch (1,26) 2 1) $ runWith "table([[0,0],[0,0]],f())"              [("f",objO [("not",mkArrO (0,0) []),("col",mkArrO (1,26) [strO "1"])])]
                     ...
                     assertEqual (Left $ TableHeaderLengthMismatch (1,16) 1 2) $ runWith "table(f(),g())"                        [("f",arrO [arrO [numO 0]]),              ("g",objO [("not",mkArrO (0,0) []),("col",mkArrO (1,16) [strO "1",strO "2"])])]
                     assertEqual (Left $ TableHeaderLengthMismatch (1,16) 2 1) $ runWith "table(f(),g())"                        [("f",arrO [arrO [numO 0],arrO [numO 0]]),("g",objO [("not",mkArrO (0,0) []),("col",mkArrO (1,16) [strO "1"])])]

test_TakeTableMin = do
                     assertEqual (Left $ IllegalTakeTableLength (1,6) 1 (-1)) $ runWith "take(-1,f())"   [("f",mkTableO (0,0) [[mkNumO (0,0) 0],[mkNumO (0,0) 0]] [])]
                     assertEqual (Left $ IllegalTakeTableLength (1,6) 1  0)   $ runWith "take(0,f())"    [("f",mkTableO (0,0) [[mkNumO (0,0) 0],[mkNumO (0,0) 0]] [])]

                     assertEqual (Left $ IllegalTakeTableLength (1,6) 1 (-1)) $ runWith "take(-1,f())"   [("f",mkTableO (0,0) [[mkNumO (0,0) 0,mkNumO (0,0) 0],[mkNumO (0,0) 0,mkNumO (0,0) 0]] [])]
                     assertEqual (Left $ IllegalTakeTableLength (1,6) 1  0)   $ runWith "take(0,f())"    [("f",mkTableO (0,0) [[mkNumO (0,0) 0,mkNumO (0,0) 0],[mkNumO (0,0) 0,mkNumO (0,0) 0]] [])]

                     assertEqual (Left $ IllegalTakeTableLength (1,6) 1 (-1)) $ runWith "take(f(),g())"  [("f",mkNumO (1,6) (-1)),("g",mkTableO (0,0) [[mkNumO (0,0) 0],[mkNumO (0,0) 0]] [])]
                     assertEqual (Left $ IllegalTakeTableLength (1,6) 1  0)   $ runWith "take(g(),f())"  [("g",mkNumO (1,6) 0),   ("f",mkTableO (0,0) [[mkNumO (0,0) 0],[mkNumO (0,0) 0]] [])]

                     assertEqual (Left $ IllegalTakeTableLength (1,6) 1 (-1)) $ runWith "take(f(),g())"  [("f",mkNumO (1,6) (-1)),("g",mkTableO (0,0) [[mkNumO (0,0) 0,mkNumO (0,0) 0],[mkNumO (0,0) 0,mkNumO (0,0) 0]] [])]
                     assertEqual (Left $ IllegalTakeTableLength (1,6) 1  0)   $ runWith "take(g(),f())"  [("g",mkNumO (1,6) 0),   ("f",mkTableO (0,0) [[mkNumO (0,0) 0,mkNumO (0,0) 0],[mkNumO (0,0) 0,mkNumO (0,0) 0]] [])]
