...
test_Show = do   assertEqual(leafTypeMismatch (1,6) NodeArr LeafTable) $ runWith "show(f())" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) NodeArr LeafPlot)  $ runWith "show(f())" [("f",mkPlotC  (1,6) [] [])]
...
test_Multi = do  assertEqual(leafTypeMismatch (1,7) NodeArr LeafTable) $ runWith "multi(f())" [("f",mkTableC (1,7) [] [])]
                 assertEqual(leafTypeMismatch (1,7) NodeArr LeafPlot)  $ runWith "multi(f())" [("f",mkPlotC  (1,7) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) (NodeOr atom) LeafTable) $ runWith "multi([f()])" [("f",mkTableC (1,8) [] [])]
                 assertEqual(leafTypeMismatch (1,8) (NodeOr atom) LeafPlot)  $ runWith "multi([f()])" [("f",mkPlotC  (1,8) [] [])]
...
test_Mean = do   assertEqual(leafTypeMismatch (1,6) NodeArr LeafTable) $ runWith "mean(f())" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) NodeArr LeafPlot)  $ runWith "mean(f())" [("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,7) (NodeOr atom) LeafTable) $ runWith "mean([f()])" [("f",mkTableC (1,7) [] [])]
                 assertEqual(leafTypeMismatch (1,7) (NodeOr atom) LeafPlot)  $ runWith "mean([f()])" [("f",mkPlotC  (1,7) [] [])]
...
test_Desc = do   assertEqual(leafTypeMismatch (1,13) NodeArr LeafTable) $ runWith "descriptive(f())" [("f",mkTableC (1,13) [] [])]
                 assertEqual(leafTypeMismatch (1,13) NodeArr LeafPlot)  $ runWith "descriptive(f())" [("f",mkPlotC  (1,13) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,14) (NodeOr atom) LeafTable) $ runWith "descriptive([f()])" [("f",mkTableC (1,14) [] [])]
                 assertEqual(leafTypeMismatch (1,14) (NodeOr atom) LeafPlot)  $ runWith "descriptive([f()])" [("f",mkPlotC  (1,14) [] [])]
...
test_Table = do  assertEqual(leafTypeMismatch (1,7) NodeArr LeafTable) $ runWith "table(f(),{})" [("f",mkTableC (1,7) [] [])]
                 assertEqual(leafTypeMismatch (1,7) NodeArr LeafPlot)  $ runWith "table(f(),{})" [("f",mkPlotC  (1,7) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,7) NodeArr LeafTable) $ runWith "table(f(),0)" [("f",mkTableC (1,7) [] [])]
                 assertEqual(leafTypeMismatch (1,7) NodeArr LeafPlot)  $ runWith "table(f(),0)" [("f",mkPlotC  (1,7) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) NodeArr LeafTable) $ runWith "table([f()],{})" [("f",mkTableC (1,8) [] [])]
                 assertEqual(leafTypeMismatch (1,8) NodeArr LeafPlot)  $ runWith "table([f()],{})" [("f",mkPlotC  (1,8) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) NodeArr LeafTable) $ runWith "table([f()],0)" [("f",mkTableC (1,8) [] [])]
                 assertEqual(leafTypeMismatch (1,8) NodeArr LeafPlot)  $ runWith "table([f()],0)" [("f",mkPlotC  (1,8) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,9) (NodeOr atom) LeafTable) $ runWith "table([[f()]],{})" [("f",mkTableC (1,9) [] [])]
                 assertEqual(leafTypeMismatch (1,9) (NodeOr atom) LeafPlot)  $ runWith "table([[f()]],{})" [("f",mkPlotC  (1,9) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,9) (NodeOr atom) LeafTable) $ runWith "table([[f()]],0)" [("f",mkTableC (1,9) [] [])]
                 assertEqual(leafTypeMismatch (1,9) (NodeOr atom) LeafPlot)  $ runWith "table([[f()]],0)" [("f",mkPlotC  (1,9) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,13) NodeObj LeafTable) $ runWith "table([[0]],f())" [("f",mkTableC (1,13) [] [])]
                 assertEqual(leafTypeMismatch (1,13) NodeObj LeafPlot)  $ runWith "table([[0]],f())" [("f",mkPlotC  (1,13) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,16) NodeArr LeafTable) $ runWith "table([[0]],{x:f()})" [("f",mkTableC (1,16) [] [])]
                 assertEqual(leafTypeMismatch (1,16) NodeArr LeafPlot)  $ runWith "table([[0]],{x:f()})" [("f",mkPlotC  (1,16) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,17) LeafStr LeafTable) $ runWith "table([[0]],{x:[f()]})" [("f",mkTableC (1,17) [] [])]
                 assertEqual(leafTypeMismatch (1,17) LeafStr LeafPlot)  $ runWith "table([[0]],{x:[f()]})" [("f",mkPlotC  (1,17) [] [])]
...
test_NTimes = do assertEqual(leafTypeMismatch (1,8) LeafNum LeafTable)  $ runWith "nTimes(f(),0)" [("f",mkTableC (1,8) [] [])]
                 assertEqual(leafTypeMismatch (1,8) LeafNum LeafPlot)   $ runWith "nTimes(f(),0)" [("f",mkPlotC  (1,8) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) LeafNum LeafTable)  $ runWith "nTimes(f(),false)" [("f",mkTableC (1,8) [] [])]
                 assertEqual(leafTypeMismatch (1,8) LeafNum LeafPlot)   $ runWith "nTimes(f(),false)" [("f",mkPlotC  (1,8) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,10) LeafNum LeafTable)  $ runWith "nTimes(0,f())" [("f",mkTableC (1,10) [] [])]
                 assertEqual(leafTypeMismatch (1,10) LeafNum LeafPlot)   $ runWith "nTimes(0,f())" [("f",mkPlotC  (1,10) [] [])]
...
test_Take = do   assertEqual(leafTypeMismatch (1,6) LeafNum LeafTable)  $ runWith "take(f(),g())"   [("g",tableO [] []),("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafPlot)   $ runWith "take(f(),g())"   [("g",tableO [] []),("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafTable)  $ runWith "take(f(),[])" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafPlot)   $ runWith "take(f(),[])" [("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafTable)  $ runWith "take(f(),0)" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafPlot)   $ runWith "take(f(),0)" [("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) (NodeOr tableOrArr) LeafPlot)   $ runWith "take(0,f())" [("f",mkPlotC  (1,8) [] [])]
...
test_Sort = do   assertEqual(leafTypeMismatch (1,6) LeafNum LeafTable)  $ runWith "sort(f(),g())"   [("g",tableO [] []),("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafPlot)   $ runWith "sort(f(),g())"   [("g",tableO [] []),("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafTable)  $ runWith "sort(f(),[])" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafPlot)   $ runWith "sort(f(),[])" [("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafTable)  $ runWith "sort(f(),0)" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafPlot)   $ runWith "sort(f(),0)" [("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) (NodeOr tableOrArr) LeafPlot) $ runWith "sort(0,f())" [("f",mkPlotC  (1,8) [] [])]
                 ...
                 assertEqual(nodeTypeMismatch [TMLeaf (1,8) LeafTable NodeArr,TMLeaf (1,9) NodeArr LeafTable]) $ runWith "sort(0,[f()])" [("f",mkTableC (1,9) [] [])]
                 assertEqual(nodeTypeMismatch [TMLeaf (1,8) LeafTable NodeArr,TMLeaf (1,9) NodeArr LeafPlot])  $ runWith "sort(0,[f()])" [("f",mkPlotC  (1,9) [] [])]
                 ...
                 assertEqual(nodeTypeMismatch [TMLeaf (1,8) LeafTable NodeArr,TMLeaf (1,10) (NodeOr atom) LeafTable])  $ runWith "sort(0,[[f()]])" [("f",mkTableC (1,10) [] [])]
                 assertEqual(nodeTypeMismatch [TMLeaf (1,8) LeafTable NodeArr,TMLeaf (1,10) (NodeOr atom) LeafPlot])   $ runWith "sort(0,[[f()]])" [("f",mkPlotC  (1,10) [] [])]
...
test_Col = do    assertEqual(leafTypeMismatch (1,5) LeafNum LeafTable)  $ runWith "col(f(),g())"   [("g",tableO [] []),("f",mkTableC (1,5) [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafPlot)   $ runWith "col(f(),g())"   [("g",tableO [] []),("f",mkPlotC  (1,5) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafTable)  $ runWith "col(f(),[])" [("f",mkTableC (1,5) [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafPlot)   $ runWith "col(f(),[])" [("f",mkPlotC  (1,5) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafTable)  $ runWith "col(f(),0)" [("f",mkTableC (1,5) [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafPlot)   $ runWith "col(f(),0)" [("f",mkPlotC  (1,5) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,7) (NodeOr tableOrArr) LeafPlot) $ runWith "col(0,f())" [("f",mkPlotC  (1,7) [] [])]
                 ...
                 assertEqual(nodeTypeMismatch [TMLeaf (1,7) LeafTable NodeArr,TMLeaf (1,8) NodeArr LeafTable]) $ runWith "col(0,[f()])" [("f",mkTableC (1,8) [] [])]
                 assertEqual(nodeTypeMismatch [TMLeaf (1,7) LeafTable NodeArr,TMLeaf (1,8) NodeArr LeafPlot])  $ runWith "col(0,[f()])" [("f",mkPlotC  (1,8) [] [])]
                 ...
                 assertEqual(nodeTypeMismatch [TMLeaf (1,7) LeafTable NodeArr,TMLeaf (1,9) (NodeOr atom) LeafTable])  $ runWith "col(0,[[f()]])" [("f",mkTableC (1,9) [] [])]
                 assertEqual(nodeTypeMismatch [TMLeaf (1,7) LeafTable NodeArr,TMLeaf (1,9) (NodeOr atom) LeafPlot])   $ runWith "col(0,[[f()]])" [("f",mkPlotC  (1,9) [] [])]
...
test_Plot = do   assertEqual(leafTypeMismatch (1,6) NodeArr LeafTable) $ runWith "plot(f(),[],{})" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) NodeArr LeafPlot)  $ runWith "plot(f(),[],{})" [("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,6) NodeArr LeafTable) $ runWith "plot(f(),[],0)" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) NodeArr LeafPlot)  $ runWith "plot(f(),[],0)" [("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,6) NodeArr LeafTable) $ runWith "plot(f(),0,0)" [("f",mkTableC (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) NodeArr LeafPlot)  $ runWith "plot(f(),0,0)" [("f",mkPlotC  (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,7) LeafNum LeafTable) $ runWith "plot([f()],[],{})" [("f",mkTableC (1,7) [] [])]
                 assertEqual(leafTypeMismatch (1,7) LeafNum LeafPlot)  $ runWith "plot([f()],[],{})" [("f",mkPlotC  (1,7) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,7) LeafNum LeafTable) $ runWith "plot([f()],[],0)" [("f",mkTableC (1,7) [] [])]
                 assertEqual(leafTypeMismatch (1,7) LeafNum LeafPlot)  $ runWith "plot([f()],[],0)" [("f",mkPlotC  (1,7) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,7) LeafNum LeafTable) $ runWith "plot([f()],0,0)" [("f",mkTableC (1,7) [] [])]
                 assertEqual(leafTypeMismatch (1,7) LeafNum LeafPlot)  $ runWith "plot([f()],0,0)" [("f",mkPlotC  (1,7) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,9) NodeArr LeafTable) $ runWith "plot([],f(),{})" [("f",mkTableC (1,9) [] [])]
                 assertEqual(leafTypeMismatch (1,9) NodeArr LeafPlot)  $ runWith "plot([],f(),{})" [("f",mkPlotC  (1,9) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,9) NodeArr LeafTable) $ runWith "plot([],f(),0)" [("f",mkTableC (1,9) [] [])]
                 assertEqual(leafTypeMismatch (1,9) NodeArr LeafPlot)  $ runWith "plot([],f(),0)" [("f",mkPlotC  (1,9) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,10) LeafNum LeafTable) $ runWith "plot([],[f()],{})" [("f",mkTableC (1,10) [] [])]
                 assertEqual(leafTypeMismatch (1,10) LeafNum LeafPlot)  $ runWith "plot([],[f()],{})" [("f",mkPlotC  (1,10) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,10) LeafNum LeafTable) $ runWith "plot([],[f()],0)" [("f",mkTableC (1,10) [] [])]
                 assertEqual(leafTypeMismatch (1,10) LeafNum LeafPlot)  $ runWith "plot([],[f()],0)" [("f",mkPlotC  (1,10) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,12) NodeObj LeafTable) $ runWith "plot([],[],f())" [("f",mkTableC (1,12) [] [])]
                 assertEqual(leafTypeMismatch (1,12) NodeObj LeafPlot)  $ runWith "plot([],[],f())" [("f",mkPlotC  (1,12) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,15) LeafStr LeafTable) $ runWith "plot([],[],{x:f()})" [("f",mkTableC (1,15) [] [])]
                 assertEqual(leafTypeMismatch (1,15) LeafStr LeafPlot)  $ runWith "plot([],[],{x:f()})" [("f",mkPlotC  (1,15) [] [])]
