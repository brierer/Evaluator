...
test_Show = do   assertEqual(leafTypeMismatch (1,6) NodeArr LeafTable) $ runWith "show(f())" [("f",[],constF $ TableO (1,6) [] [])]
...
test_Multi = do  assertEqual(leafTypeMismatch (1,7) NodeArr LeafTable) $ runWith "multi(f())" [("f",[],constF $ TableO (1,7) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) (NodeOr atom) LeafTable) $ runWith "multi([f()])" [("f",[],constF $ TableO (1,8) [] [])]
                 assertEqual(leafTypeMismatch (1,8) (NodeOr atom) LeafPlot)  $ runWith "multi([f()])" [("f",[],constF $ PlotO  (1,8) [] [])]
...
test_Mean = do   assertEqual(leafTypeMismatch (1,6) NodeArr LeafTable) $ runWith "mean(f())" [("f",[],constF $ TableO (1,6) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,7) (NodeOr atom) LeafTable) $ runWith "mean([f()])" [("f",[],constF $ TableO (1,7) [] [])]
                 assertEqual(leafTypeMismatch (1,7) (NodeOr atom) LeafPlot)  $ runWith "mean([f()])" [("f",[],constF $ PlotO  (1,7) [] [])]
...
test_Desc = do   assertEqual(leafTypeMismatch (1,13) NodeArr LeafTable) $ runWith "descriptive(f())" [("f",[],constF $ TableO (1,13) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,14) (NodeOr atom) LeafTable) $ runWith "descriptive([f()])" [("f",[],constF $ TableO (1,14) [] [])]
                 assertEqual(leafTypeMismatch (1,14) (NodeOr atom) LeafPlot)  $ runWith "descriptive([f()])" [("f",[],constF $ PlotO  (1,14) [] [])]
...
test_Table = do  assertEqual(leafTypeMismatch (1,7) NodeArr LeafTable) $ runWith "table(f(),{})" [("f",[],constF $ TableO (1,7) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,9) (NodeOr atom) LeafTable) $ runWith "table([[f()]],{})" [("f",[],constF $ TableO (1,9) [] [])]
                 assertEqual(leafTypeMismatch (1,9) (NodeOr atom) LeafPlot)  $ runWith "table([[f()]],{})" [("f",[],constF $ PlotO  (1,9) [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,9) (NodeOr atom) LeafTable) $ runWith "table([[f()]],0)" [("f",[],constF $ TableO (1,9) [] [])]
                 assertEqual(leafTypeMismatch (1,9) (NodeOr atom) LeafPlot)  $ runWith "table([[f()]],0)" [("f",[],constF $ PlotO  (1,9) [] [])]
...
test_NTimes = do assertEqual(leafTypeMismatch (1,8) LeafNum LeafTable)  $ runWith "nTimes(f(),0)" [("f",[],constF $ TableO (1,8) [] [])]
...
test_Take = do   assertEqual(leafTypeMismatch (1,6) LeafNum LeafTable)  $ runWith "take(f(),g())"   [("g",[],constF $ tableO [] []),("f",[],constF $ TableO (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafPlot)   $ runWith "take(f(),g())"   [("g",[],constF $ tableO [] []),("f",[],constF $ PlotO  (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum NodeArr)    $ runWith "take([],g())"    [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum NodeObj)    $ runWith "take({},g())"    [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafStr)    $ runWith "take(\"\",g())"  [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafBool)   $ runWith "take(false,g())" [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafNull)   $ runWith "take(null,g())"  [("g",[],constF $ tableO [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) (NodeOr tableOrArr) LeafPlot)   $ runWith "take(0,f())" [("f",[],constF $ PlotO  (1,8) [] [])]
...
test_Sort = do   assertEqual(leafTypeMismatch (1,6) LeafNum LeafTable)  $ runWith "sort(f(),g())"   [("g",[],constF $ tableO [] []),("f",[],constF $ TableO (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafPlot)   $ runWith "sort(f(),g())"   [("g",[],constF $ tableO [] []),("f",[],constF $ PlotO  (1,6) [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum NodeArr)    $ runWith "sort([],g())"    [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum NodeObj)    $ runWith "sort({},g())"    [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafStr)    $ runWith "sort(\"\",g())"  [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafBool)   $ runWith "sort(false,g())" [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,6) LeafNum LeafNull)   $ runWith "sort(null,g())"  [("g",[],constF $ tableO [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,8) (NodeOr tableOrArr) LeafPlot) $ runWith "sort(0,f())" [("f",[],constF $ PlotO  (1,8) [] [])]
                 ...
                 assertEqual(nodeTypeMismatch [TMLeaf (1,8) LeafTable NodeArr,TMLeaf (1,10) (NodeOr atom) LeafTable])  $ runWith "sort(0,[[f()]])" [("f",[],constF $ TableO (1,10) [] [])]
                 assertEqual(nodeTypeMismatch [TMLeaf (1,8) LeafTable NodeArr,TMLeaf (1,10) (NodeOr atom) LeafPlot])   $ runWith "sort(0,[[f()]])" [("f",[],constF $ PlotO  (1,10) [] [])]
...
test_Col = do    assertEqual(leafTypeMismatch (1,5) LeafNum LeafTable)  $ runWith "col(f(),g())"   [("g",[],constF $ tableO [] []),("f",[],constF $ TableO (1,5) [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafPlot)   $ runWith "col(f(),g())"   [("g",[],constF $ tableO [] []),("f",[],constF $ PlotO  (1,5) [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum NodeArr)    $ runWith "col([],g())"    [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum NodeObj)    $ runWith "col({},g())"    [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafStr)    $ runWith "col(\"\",g())"  [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafBool)   $ runWith "col(false,g())" [("g",[],constF $ tableO [] [])]
                 assertEqual(leafTypeMismatch (1,5) LeafNum LeafNull)   $ runWith "col(null,g())"  [("g",[],constF $ tableO [] [])]
                 ...
                 assertEqual(leafTypeMismatch (1,7) (NodeOr tableOrArr) LeafPlot) $ runWith "col(0,f())" [("f",[],constF $ PlotO  (1,7) [] [])]
                 ...
                 assertEqual(nodeTypeMismatch [TMLeaf (1,7) LeafTable NodeArr,TMLeaf (1,9) (NodeOr atom) LeafTable])  $ runWith "col(0,[[f()]])" [("f",[],constF $ TableO (1,9) [] [])]
                 assertEqual(nodeTypeMismatch [TMLeaf (1,7) LeafTable NodeArr,TMLeaf (1,9) (NodeOr atom) LeafPlot])   $ runWith "col(0,[[f()]])" [("f",[],constF $ PlotO  (1,9) [] [])]
...
test_Plot = do   assertEqual(leafTypeMismatch (1,6) NodeArr LeafTable) $ runWith "plot(f(),[],{})" [("f",[],constF $ TableO (1,6) [] [])]
